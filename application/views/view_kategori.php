    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg" onclick="submit('tambah')">
